	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float simplePerlin2D659 = snoise( (v.vertex*1.0 + ( _TimeParameters.x * _WindMovement )).xy*_WindDensity );
				simplePerlin2D659 = simplePerlin2D659*0.5 + 0.5;
				float4 appendResult670 = (float4(( ( ( ( simplePerlin2D659 - 0.5 ) / 10.0 ) * _WindStrength ) + v.vertex.x ) , v.vertex.y , v.vertex.z , 1.0));
				#ifdef _WINDMASKONOFF_ON
				float staticSwitch668 = ( ( 1.0 - v.texcoord.y ) * 5.0 );
				#else
				float staticSwitch668 = v.vertex.y;
				#endif
				float4 lerpResult671 = lerp( v.vertex , appendResult670 , staticSwitch668);
				float4 transform672 = mul(GetWorldToObjectMatrix(),float4( _WorldSpaceCameraPos , 0.0 ));
				float4 temp_cast_2 = (transform672.w).xxxx;
				#ifdef _CUSTOMWIND_ON
				float4 staticSwitch674 = ( lerpResult671 - temp_cast_2 );
				#else
				float4 staticSwitch674 = v.vertex;
				#endif
				float4 LOCALWIND675 = staticSwitch674;
				...
				float3 vertexValue = LOCALWIND675.xyz;
						 ...
						 ) : SV_Target
			{
				...
				float clampResult647 = clamp( ( (0.5 + (IN.ase_texcoord9.y - 0.0) * (2.0 - 0.5) / (1.0 - 0.0)) * _Gradient ) , 0.0 , 1.0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float4 appendResult670 = (float4(( ( ( ( simplePerlin2D659 - 0.5 ) / 10.0 ) * _WindStrength ) + v.vertex.x ) , v.vertex.y , v.vertex.z , 1.0));
				#ifdef _WINDMASKONOFF_ON
				float staticSwitch668 = ( ( 1.0 - v.ase_texcoord.y ) * 5.0 );
				#else
				float staticSwitch668 = v.vertex.y;
				#endif
				float4 lerpResult671 = lerp( v.vertex , appendResult670 , staticSwitch668);
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 appendResult670 = (float4(( ( ( ( simplePerlin2D659 - 0.5 ) / 10.0 ) * _WindStrength ) + v.vertex.x ) , v.vertex.y , v.vertex.z , 1.0));
				#ifdef _WINDMASKONOFF_ON
				float staticSwitch668 = ( ( 1.0 - v.texcoord0.y ) * 5.0 );
				#else
				float staticSwitch668 = v.vertex.y;
				#endif
				float4 lerpResult671 = lerp( v.vertex , appendResult670 , staticSwitch668);
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode2 = tex2D( _BaseTexture, uv_BaseTexture2 );
				float clampResult647 = clamp( ( (0.5 + (IN.ase_texcoord5.y - 0.0) * (2.0 - 0.5) / (1.0 - 0.0)) * _Gradient ) , 0.0 , 1.0 );
				float clampResult555 = clamp( pow( clampResult647 , _GradientPower ) , 0.0 , 1.0 );
				float4 lerpResult557 = lerp( _GroundColor , _TopColor , clampResult555);
				float4 Gradient558 = lerpResult557;
				float grayscale180 = dot(tex2DNode2.rgb, float3(0.299,0.587,0.114));
...
Node;AmplifyShaderEditor.RangedFloatNode;566;1395.757,413.0894;Inherit;False;Property;_Smoothness;Smoothness;11;0;Create;True;0;0;0;False;0;False;0.7748996;0.48;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;650;2050.875,361.853;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;651;2050.875,361.853;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.CommentaryNode;652;-4214.021,3718.571;Inherit;False;3563.478;765.4585;WIND;24;676;675;674;673;672;671;670;669;668;667;666;665;664;663;662;661;660;659;658;657;656;655;654;653;WIND;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleTimeNode;653;-4118.424,4047.767;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;654;-4188.842,4176.891;Inherit;False;Property;_WindMovement;Wind Movement;13;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;655;-3924.436,4050.706;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;656;-4016.848,3754.713;Inherit;False;1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;657;-3870.36,4180.19;Inherit;False;Property;_WindDensity;Wind Density;14;0;Create;True;0;0;0;False;0;False;3.3;1.91;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;658;-3780.749,3945.188;Inherit;False;3;0;FLOAT4;0,0,0,0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.NoiseGeneratorNode;659;-3553.023,3957.42;Inherit;False;Simplex2D;True;False;2;0;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;660;-3347.233,3970.018;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;661;-3207.387,3964.533;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;10;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;662;-3540.493,4204.375;Inherit;False;Property;_WindStrength;Wind Strength;15;0;Create;True;0;0;0;False;0;False;0.3;0.203;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;663;-3670.865,4285.544;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;664;-3082.586,3962.911;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;665;-3413.781,4324.605;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;666;-3168.93,4205.112;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;667;-2935.895,3865.822;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;668;-2926.806,4152.38;Inherit;False;Property;_WINDMASKONOFF;WIND MASK ON/OFF;12;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceCameraPos;669;-2565.003,4107.854;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DynamicAppendNode;670;-2685.752,3806.726;Inherit;True;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;1;False;1;FLOAT4;0
Node;AmplifyShaderEditor.LerpOp;671;-2440.99,3821.558;Inherit;True;3;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.WorldToObjectTransfNode;672;-2315.937,4101.105;Inherit;False;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleSubtractOpNode;673;-2142.972,3840.063;Inherit;True;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.StaticSwitch;674;-1900.075,3752.336;Inherit;True;Property;_CUSTOMWIND;CUSTOM WIND;10;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;675;-1155.3,3755.028;Inherit;True;LOCALWIND;-1;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.RangedFloatNode;676;-3608.323,4412.118;Inherit;False;Constant;_VertexMask;Vertex Mask;21;0;Create;True;0;0;0;False;0;False;5;0.5;-5;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;354;1726.764,679.1421;Inherit;True;675;LOCALWIND;1;0;OBJECT;;False;1;FLOAT4;0
...
WireConnection;664;1;662;0
WireConnection;665;0;663;2
WireConnection;666;0;665;0
WireConnection;666;1;676;0
WireConnection;667;0;664;0
WireConnection;667;1;656;1
WireConnection;668;1;656;2
WireConnection;668;0;666;0
WireConnection;670;0;667;0
WireConnection;670;1;656;2
WireConnection;670;2;656;3
WireConnection;671;0;656;0
WireConnection;671;1;670;0
WireConnection;671;2;668;0
WireConnection;672;0;669;0
WireConnection;673;0;671;0
WireConnection;673;1;672;4
WireConnection;674;1;656;0
WireConnection;674;0;673;0
WireConnection;675;0;674;0
ASEEND*/
//CHKSM=05A7B1C1360FAC8C7833497C566D6C1F59866AEA