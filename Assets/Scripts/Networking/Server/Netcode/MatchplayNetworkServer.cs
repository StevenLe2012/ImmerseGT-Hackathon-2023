...
public class MatchplayNetworkServer : IDisposable
{
    ...
    // private const string CONFIGURE_SERVER_SCENE = "UI_Hands"; // WE ADDED
    // private const string LOAD_GAME_SCENE = "UI_Hands"; // WE ADDED
    private const string CONFIGURE_SERVER_SCENE = "CharacterSelect";
    private const string LOAD_GAME_SCENE = "Gameplay";
    ...
    {
        networkManager.SceneManager.LoadScene(CONFIGURE_SERVER_SCENE, LoadSceneMode.Single);
    ...
    public void StartGame()
    {
        ...
        NetworkManager.Singleton.SceneManager.LoadScene(LOAD_GAME_SCENE, LoadSceneMode.Single);
    }
